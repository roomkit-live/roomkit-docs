...
| `TTSContextLevel.SELF` | Its own previous turns, and how much of each was played | Continuity handles returned by a cloud API |
...
utterance. A call cancelled before any audio played leaves no turn. A speech
